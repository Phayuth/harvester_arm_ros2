...
class GripperIO:
    ...
    def goto(self, pos, vel, force):
        self.rACT = 1
        self.rGTO = 1
        self.rPR = pos#int(np.clip((3.-230.)/0.085 * pos + 230., 0, 255))
        self.rSP = vel#int(np.clip(255./(0.1-0.013) * vel-0.013, 0, 255))
        self.rFR = force#int(np.clip(255./(220.-5.) * force-5., 0, 255))
        self._update_cmd()
